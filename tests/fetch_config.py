...
def create_parser():
    ...
    arg_parser = argparse.ArgumentParser(
        description="Retrieve login info and " "store it in a temp file"
    )
    ...
    arg_parser.add_argument(
        "--unverified_ssl_context", action="store_true", default=False
    )
